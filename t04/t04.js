...
function preload() {
  ...
  imagenArco = loadImage('futbol.avif');//l arco
  imagenMessi = loadImage('leo.jpg');//en de Messi

  // Cargar los sonidos
  sonidoCorrecto = loadSound('correcto.mp3');
  sonidoIncorrecto = loadSound('perder.mp3');//
  musicaFondo = loadSound('gol.mp3');//Música de fondo
  sonidoGol = loadSound('gol.mp3'); // Sonido para el gol
}
